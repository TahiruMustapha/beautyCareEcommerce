    ...
    <header className=" relative w-full h-fit  sm:h-[30vh] pb-2     z-50 bg-white">
      ...
      <div className=" relative">
        ...
        <div className=" ease-in-out duration-500 sm:hidden flex  absolute top-[3.8rem] left-2.5 text-[#444] w-[95%] m-auto items-center justify-between p-3 bg-[#80808071] h-10">
          ...
          <div className="cartInfo">
                  <div
                    className="modal fixed top-44 mt-2 ml-auto mr-auto left-0 right-0 bottom-0 w-[80%] h-fit bg-[#00000055] z-[9999]"
                    style={{
                      display: openCart ? "block" : "none",
                    }}
                  >
          ...
          {productInCart.length > 0 && (
                    <div className=" absolute bg-[orangered] w-3 h-3 rounded-full text-xs flex items-center text-white justify-center font-bold top-20 right-[10.5rem] m-0">
                      {productInCart.length}
                    </div>
                  )}
