...
const Footer = () => {
  return (
    <div className="mt-[45rem] w-full lg:mt-[48rem]   bg-gray-200 h-fit pb-5 pl-5 pt-5">
      <div className=" flex-col w-full  sm:grid grid-cols-2 md:grid grid-cols-3 lg:grid grid-cols-4 xl:grid grid-cols-4    ">
